...
function buildGradientCSS() {var _stops$at$color, _stops$at;
...
@media (prefers-reduced-motion: no-preference) {
  ...
  .accordion p::selection {
    background: ${(_stops$at$color = (_stops$at = stops.at(-1)) === null || _stops$at === void 0 ? void 0 : _stops$at.color) !== null && _stops$at$color !== void 0 ? _stops$at$color : 'light-dark(#000, #fff)'};
...
function buildPane() {
  ...
  ctrl.on('change', event => {var _event$target$control;
    const label = (_event$target$control = event.target.controller.view.labelElement) === null || _event$target$control === void 0 ? void 0 : _event$target$control.innerText;
...
class PlatformAccordion extends HTMLElement {
  ...
  async close(li) {var _li$querySelector, _wrap$getAnimations;
    const wrap = li.querySelector('.content-wrap');
    li.removeAttribute('data-open');
    (_li$querySelector = li.querySelector('button[aria-controls]')) === null || _li$querySelector === void 0 ? void 0 : _li$querySelector.setAttribute(
    'aria-expanded',
    'false');

    await Promise.allSettled(
    ((_wrap$getAnimations = wrap === null || wrap === void 0 ? void 0 : wrap.getAnimations()) !== null && _wrap$getAnimations !== void 0 ? _wrap$getAnimations : []).
