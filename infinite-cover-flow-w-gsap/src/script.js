import gsap from 'https://esm.sh/gsap@3.7.0'
import ScrollTrigger from 'https://esm.sh/gsap@3.7.0/ScrollTrigger'
import Draggable from 'https://esm.sh/gsap@3.7.0/Draggable'
