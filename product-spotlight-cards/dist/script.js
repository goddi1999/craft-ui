...
class ProductSpotlight extends HTMLElement {
  ...
  connectedCallback() {
    ...
    if (card && !card._spotlightFocusBound) {
      ...
      card.addEventListener('focusout', e => {var _e$relatedTarget;
        if ((_e$relatedTarget = e.relatedTarget) !== null && _e$relatedTarget !== void 0 && _e$relatedTarget.closest('[role="tablist"]')) return;
        for (const sp of getSiblings()) {
          sp._focused = false;
          renderManager.wake(sp);
        }
...
class SpotlightCarousel extends HTMLElement {
  ...
  _setActive(idx) {var _this$_markers$this$_, _this$_markers$idx;
    (_this$_markers$this$_ = this._markers[this._current]) === null || _this$_markers$this$_ === void 0 ? void 0 : _this$_markers$this$_.setAttribute('aria-selected', 'false');
    if (!this._isBlueprint) {var _this$_markers$this$_2;
      (_this$_markers$this$_2 = this._markers[this._current]) === null || _this$_markers$this$_2 === void 0 ? void 0 : _this$_markers$this$_2.setAttribute('tabindex', '-1');
    }
    this._current = idx;
    (_this$_markers$idx = this._markers[idx]) === null || _this$_markers$idx === void 0 ? void 0 : _this$_markers$idx.setAttribute('aria-selected', 'true');
    if (!this._isBlueprint) {var _this$_markers$idx2;
      (_this$_markers$idx2 = this._markers[idx]) === null || _this$_markers$idx2 === void 0 ? void 0 : _this$_markers$idx2.setAttribute('tabindex', '0');
    }
  }}
...
document.querySelectorAll('.card:not(.card--blueprint)').forEach(card => {
  card.addEventListener('click', e => {var _card$querySelector;
    if (e.target.closest('a, [role="tablist"]')) return;
    (_card$querySelector = card.querySelector('a')) === null || _card$querySelector === void 0 ? void 0 : _card$querySelector.click();
  });
});
