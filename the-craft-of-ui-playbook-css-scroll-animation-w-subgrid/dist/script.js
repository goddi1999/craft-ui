...
const update = () => {
  ...
  } else {var _scalerTl, _layersTl;
    gsap.set(['.scaler img', '.layer'], {
      attr: {
        style: undefined } });


    (_scalerTl = scalerTl) === null || _scalerTl === void 0 ? void 0 : _scalerTl.kill();
    (_layersTl = layersTl) === null || _layersTl === void 0 ? void 0 : _layersTl.kill();
    scalerTl = undefined;
    layersTl = undefined;
  }
