...
```markdown
## Goal
<!-- One sentence: what does this feature accomplish? What is the user value? -->
...
<!-- Must prove that Detailed Requirements work end-to-end. Use real values, not abstract labels. -->
...
<!-- Add as many as needed. Each subtask = one PR or one testable unit of work. -->
```
...
## Minimal Version (for Small Tasks)

For quick fixes or tiny features, use this reduced form. The 7 keywords still apply — just fewer list items.
...
*This template is maintained as part of the WQ · Motion Aware Learning platform specification standards.*
